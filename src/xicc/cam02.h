...
extern int printCAM;                    /* Switch for printing cam scene parameters */

/* Global constants for poor man's JMh mapping */
extern int theSource;                   /* Flag to store source Fl as srcFl in set_view of cam02.c */
extern int theDest;                     /* Flag to store destination Fl as dstFl in set_view of cam02.c */
extern double srcFl;
extern double dstFl;
...
/* Public: */
    ...
    int (*QMh_to_XYZ)(struct _cam02 *s, double *out, double *in);
    int (*JMh_to_XYZ)(struct _cam02 *s, double *out, double *in);
...
/* Private: */
	...
	double Nbb;			                /* Background brightness induction factor */
	double Ncb;			                /* Chromatic brightness induction factor */
	...
	double hkscale;		                /* [1.0] Scale HK effect up/down from default  -     ?? was int in original? then incorrect? */
    ...
    double color_ss;                    /* Scaling factor */
    double color_bass;                  /* Blue angle scaling factor */
    double color_ja;                    /* Scaled a */
    double color_jb;                    /* Scaled b */
    
    /* Scene viewing condition parameters */
    double src_Fl;                      /* Source Fl */
    double dst_Fl;                      /* Destination Fl */
